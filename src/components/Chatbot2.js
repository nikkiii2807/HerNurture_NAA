...
import "./Chatbot2.css"; // For styling
  ...
  return (
    <div className="chatbot-container">
      <div className="chatbot-header">
        <h3>Pregnancy Support and Guidance</h3> {/* Updated h3 text */}
      </div>
      ...
      <div className="chatbot-footer">
        <input
          ...
          placeholder="How are you feeling today? Let’s talk about pregnancy progress." 
          autoFocus
        />
